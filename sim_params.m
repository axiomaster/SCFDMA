...
sim_param.N_pilot = 2;             %导频数量 2导频 or 4导频
sim_param.modType  = 2;        %调制方式[1, 2] for ['QPSK,'16QAM']
sim_param.Rx = 2;                 %接收天线数
sim_param.corrLevel = 'Low';
sim_param.chanEstOn = 0;                 %真实信道估计:1   /    理想信道估计:0
...
sim_param.userBits = sim_param.M*(sim_param.N_symb*sim_param.N_slot-sim_param.N_pilot-1)*sim_param.Qm; %用户比特数
