function mapping = LTE_common_turbo_encoder_generate_interleaving_mapping(sim_param,code_block_size)
...
f1 = sim_param.turbo_interleaver_table(real_index,2);
f2 = sim_param.turbo_interleaver_table(real_index,3);
